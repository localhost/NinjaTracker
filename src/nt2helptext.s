...
onlinehelptext: dc.b "NinjaTrackerV2.02 online help           "
                dc.b "                                        "
                ...
                dc.b "                                        "
                dc.b "The combined length of a subtune's all  "
                dc.b "tracks cannot exceed 256 bytes.         "
                dc.b "                                        "
                ...
                dc.b "However, for the last step of a pattern "
                dc.b "the minimum duration is 3, if there is  "
                dc.b "a transpose or song loop coming up, or  "
                dc.b "4 if both transpose and song loop are   "
                dc.b "coming up. If these minimums are not met"
                dc.b "the correct pattern will not be played  "
                dc.b "next.                                   "
                dc.b "                                        "
                ...
                dc.b "jumps to the last arpeggio-step, normal "
                dc.b "or delayed, that was executed before the"
                dc.b "slide started.                          "
                dc.b "                                        "
                ...
                dc.b "                                        "
                dc.b "Accessed from the disk menu, these are  "
                dc.b "the hardrestart sustain/release value   "
                dc.b "(default 00) and note init frame wave-  "
                dc.b "form (default 08). They are also saved  "
                dc.b "with each song.                         "
                dc.b "                                        "
                dc.b "To get brighter attack to noise, try    "
                dc.b "init waveform 00 (no testbit). If you   "
                dc.b "want one-frame hardrestart like in V2.0,"
                dc.b "set gatebit in the init waveform, but   "
                dc.b "then you must have full sustain (F) in  "
                dc.b "hardrestart SR value or otherwise there "
                dc.b "is usually no sound!                    "
                dc.b "                                        "
                dc.b "3.6 Playback optimizations              "
                dc.b "                                        "
                dc.b "Reading pattern data for a new pattern  "
                dc.b "step is split on 2 frames just before   "
                dc.b "the new step begins. During this time,  "
                dc.b "pulsetable execution is skipped if the  "
                dc.b "channel has a running wavetable program."
                dc.b "                                        "
                dc.b "Command execution and new note init is  "
                dc.b "performed on the latter of those frames."
                dc.b "During that, both pulsetable and wave-  "
                dc.b "table execution are skipped.            "
                dc.b "                                        "
                dc.b "To minimize the effect of optimizations "
